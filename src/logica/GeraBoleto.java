...
public class GeraBoleto implements LogicaDeNegocio{
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		 ...
		 */
		Cedente cedente = new Cedente("CEBUDV - Núcleo "+objNucleo.getNome(),objNucleo.getCnpj());
		...
		*/
		...
		contaBancaria.setNumeroDaConta(new NumeroDaConta(123456, "0")); //Pegar no cadastro do núcleo
		...
		boleto.setInstrucao1("Após 5 dias cobrar acréscimo de 3% a.m.");
		/*
