...
public class AlteraBanco implements LogicaDeNegocio{ //Socio(Principal)
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(desBan!=null&&desBan!=""){	
			...
			if(itemRecBan!=null){
				...
				daoAltF.alterarBanco(itemBan);

				itemBan = BancoDAO.consultarBanco(itemBan);
				mens = "Item atualizado: "+itemBan.getDescricao();
			}
