	        ...
	        <form id="formNome" name="formNome" method="post" >
	            ...
	            <tr>
					<td><div align="left" class="style6">
	                   ...
	                   <input class="input-mini" name="ano_paga" id="ano_paga" type="text" style="font-size: 16px; color: #006633; font-weight: bold;" value="${objMovIni.ano}" title="Escolha o ano na caixa de seleção" size="4" maxlength="4" /> <!-- readonly -->
	            	   <img src="imagens/spacer_1x1px.png" width="5" border="0" />Até o mês:<img src="imagens/spacer_1x1px.png" width="2" border="0" />                
	                   ...
	                   <input name="mesfin_paga" id="mesfin_paga" type="hidden" style="font-size: 16px; color: #006633; font-weight: bold;" value="${objMovIni.mes}" title="Escolha o mes final na caixa de seleção" size="1" maxlength="1" readonly/>
