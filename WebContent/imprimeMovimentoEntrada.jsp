            ...
            <table width="660" border="1" align="center" bordercolor="#000000">
		       ...
		       <c:forEach var="linhasentrada" items="${listEntrada}">
                  <c:if test="${numeroRecibo != linhasentrada.recibo && vlrtotal!=0}">
                     ...
                     <tr bordercolor="#000000">
                     	<td><div align="center" style="font-size: 12px; color: #333333;">Em: <f:formatDate value="${linhasentrada.data.time}" type="date" pattern="dd/MM/yyyy" /></div></td>
                  ...
                  <tr bordercolor="#000000">
	                  <c:if test="${numeroRecibo != linhasentrada.recibo}">
	               	     ...
	               	     <td colspan="2"><div align="left" style="font-size: 14px; color: #333333;"><img src="imagens/spacer_1x1px.png" width="5" border="0" />${linhasentrada.socioPagador.nome}</div></td>               	     
	               	     <c:set var="cancela" value="0"/> 
	                     <c:set var="vlrtotal" value="0"/>                     
               ...
               <c:if test="${vlrtotal!=0}">
       		   ...
       		   <c:if test="${totalFPSG != 0}">
				  <tr bordercolor="#ffffff"><td colspan="3">&nbsp;</td></tr>
                  <tr bordercolor="#000000"><td colspan="3"><div align="right" style="font-size: 16px; color: #333333;">Total de associados que pagaram somente Fundos de Participação: ${totalFPSG}<img src="imagens/spacer_1x1px.png" width="5" border="0" /></div></td></tr>
               </c:if>
            </table>
            </form>
		<hr/>
