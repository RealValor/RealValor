	...
	<div class="hero-unit" align="center">
		<div id="estrutura">
			<table width="764" frame="void">
			   <tr><td colspan="3"><div align="left" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #666666; font-weight: bold;">Listagem de associados</div></td></tr>     
	           <tr><td>&nbsp;</td></tr>
			</table>
			...
			<form name="form" id="form" method="post">
			  ...
			  <table width="762" border="1">
		      	<tr><td colspan="5"><input type="button" onclick="enviar('IncluiSocio')" name="bt1" value="Voltar"></input></td></tr>
		    	...
		    	<tr bordercolor="#cccccc" bgcolor="#cccccc">
		          ...
		          <c:forEach var="socio" items="${listSoc}">
				     <c:if test="${socio.nome!=''}">
				     	<tr bgcolor="#ffffff">
					        <td><div align="center"><a href="stu?p=ConsultaSocio&cod_socio=${socio.codigo}"><img src="imagens/edit.png" width="16" height="16" border="0" align="middle" /></a></div></td>
							<td><div align="left" style="font-size: 12px; color: #000000;">${socio.nome}</div></td>
							<td><div align="left" style="font-size: 12px; color: #000000;">${ socio.cpf==0?'':socio.cpf }</div></td>
							<td><div align="left" style="font-size: 12px; color: #000000;">${socio.telefone}</div></td>
			            </tr>
					 </c:if>
		          </c:forEach>
