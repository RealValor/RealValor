		...
		<script>
		 ...
		 function visualizar(){
		    ...
		    if(document.getElementById('controle').value+1>1){
			   window.open(document.getElementById('urlSet').value+'imprimeMovimentoEntrada.jsp?cod='+seconds,'janela', 'width='+width+', height='+height+', top='+top+', left='+left+', scrollbars=yes, status=no, toolbar=no, location=no, directories=no, menubar=no, resizable=no, fullscreen=no');
		    }
		 }
	  </script>
 ...
 -->
	  ...
	  <div class="hero-unit" align="center">
	        ...
	        <table width="764" frame="void">
			   ...
			   <tr><td colspan="3"><div align="left" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #666666; font-weight: bold;">Consulta Movimento Entrada</div></td></tr>     
			   <tr><td colspan="17">&nbsp;</td></tr>	  
		    </table>
	        ...
	        <form id="formNome" name="formNome" method="post" action="stu?p=ConsultaMensalidade">
	            ...
	            <tr>
					<td><div align="left" class="style6">
	                   ...
	                   <input type="button" onclick="enviar('ConsultaMovimentoEntrada')" name="bt5" value="Confirma">
	            	</div></td>
	            </tr>
				<tr><td>&nbsp;</td></tr>	  
	            </table>
