  ...
  <div class="hero-unit" align="center">
	  <div id="estrutura">
        <table width="764" frame="void">
		   ...
		   <tr><td colspan="3"><div align="left" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #666666; font-weight: bold;">Consulta Recibo</div></td></tr>     
		   <tr><td colspan="17">&nbsp;</td></tr>	  
	    </table>
		...
		<form id="formNome" name="formNome" method="post">
            ...
            <tr>
            	<td><div align="left"  class="style6" >Nº. Recibo:<img src="imagens/spacer_1x1px.png" width="2" border="0" />
				 ...
				 <input class="input-mini" name="numero_recibo" type="text" id="numero_recibo" style="font-size: 16px; color: #006633; font-weight: bold;" size="4" maxlength="6" title="Numero do Recibo" value='<f:formatNumber value="${numeroRecibo}" type="number" pattern="######"/>' onkeypress="return soNumero(event);" />			      
            ...
            <table width="763" class="table table-condensed">
		       ...
		       <c:forEach var="linhasrecibo" items="${listaRec}">
                  ...
                  <c:forEach var="linhassocio" items="${listaSoc}">
	               ...
	               <tr>
	                   <td colspan="18"><div align="right" style="font-size: 12px; color: #000000;"><strong>Data do Recibo: </strong><img src="imagens/spacer_1x1px.png" width="5" border="0" />
		               <input name="data_recibo" type="text" id="data_recibo" class="input-small" size="10" maxlength="10" style="font-size: 14px; color: #333333;" value='<f:formatDate value="${recibo.data.time}" pattern="dd/MM/yyyy"/>' onkeypress="return mascara(event,this,'##/##/####');" /></div></td>
	               </tr>
               </c:if>
	  	  ...
	  	  <table width="764" frame="void">
  			 <tr>
                	<td colspan="3">
                    	<div align="left">
                    		<c:if test="${not empty listaRec}">
					        	<input type="button" onclick="mudardata()" name="bt1" value="Mudar Data">   
                    		</c:if>
	...
	<script>
     	 ...
     	 function mudardata(){
 			if(!confirm('Nova data: '+document.getElementById("data_recibo").value+'. Confirma?')){
				return false;
			}else{
	     		enviar('AlteraDataRecibo');
			}
     	 }
