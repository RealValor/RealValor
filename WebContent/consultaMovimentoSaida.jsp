		...
		<script>
		 ...
		 function visualizar(){
		    ...
		    if(document.formNome.controle.value+1>1){
			   window.open(document.getElementById('urlSet').value+'imprimeMovimentoSaida.jsp?cod='+seconds,'janela', 'width='+width+', height='+height+', top='+top+', left='+left+', scrollbars=yes, status=no, toolbar=no, location=no, directories=no, menubar=no, resizable=no, fullscreen=no');
		    }
		 }
	  ...
	  <div class="hero-unit" align="center">
	     <div id="estrutura">
	        <table width="764" frame="void">
			   ...
			   <tr><td colspan="3"><div align="left" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #666666; font-weight: bold;">Consulta Movimento Saída</div></td></tr>     
			   <tr><td colspan="17">&nbsp;</td></tr>	  
		    </table>
	        ...
	        <form id="formNome" name="formNome" method="post" action="stu?p=ConsultaMensalidade">
	            ...
	            <tr>
					<td><div align="left" class="style6">
	                   ...
	                   <select class="input-small" name="mes" id="mes" style="font-size: 16px; color: #006633; font-weight: bold;" onchange='document.getElementById("mesfin_paga").value=mesfin.value'>
	                   ...
	                   <input name="mesfin_paga" id="mesfin_paga" type="hidden" style="font-size: 16px; color: #006633; font-weight: bold;" value="${objMovFin.mes}" title="Escolha o mes final na caixa de seleção" size="1" maxlength="1" readonly/>
	                   <input name="controle" id="controle" type="hidden" value="${totSaidas}" size="1" maxlength="2" />
	                   <input name="urlSet" id="urlSet" type="hidden" value="${urlSet}"/>
	                   <input type="button" onclick="enviar('ConsultaMovimentoSaida')" name="bt5" value="Confirma">
	            	</div></td>
	            </tr>
	            </table>
	            <table width="763" frame="void" >
