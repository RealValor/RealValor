	  ...
	  <div class="hero-unit" align="center">
		  <div id="estrutura">
	      	<table width="764" frame="void">
		       ...
		       <tr><td colspan="3"><div align="left" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #666666; font-weight: bold;">Consulta Núcleo - ${objNucleo.regiao.descricao}</div></td></tr>
		       <tr><td colspan="17">&nbsp;</td></tr>     
		    </table>
			...
			<form name="form" id="form" method="post">
	          <table width="760" border="1">
				   ...
				   <c:if test="${not empty listaNucleos}">
	             	<div align="center" style="font-size: 16px; color: #000000;"><strong>Relação de Núcleos da ${objNucleo.regiao.descricao}</strong></div>
			       ...
			       <c:forEach var="linhaslista" items="${listaNucleos}">
	           	       <tr bgcolor="#ffffff">
	               		<td><div align="center"><a href='stu?p=AlteraNucleo&num=${linhaslista.codigo}' title="Edita Núcleo"><img src="imagens/edit.png" width="16" height="16" border="0" align="middle" /></a></div></td>
	               		<!-- 
 				   ...
 				   <tr bordercolor="#CCCCCC" bgcolor="#CCCCCC"><td bordercolor="#ffffff">&nbsp;</td>
		               ...
		               <td bordercolor="#ffffff" ><div align="right" style="font-size: 12px; color: #000000;"><strong>Núcleos: <f:formatNumber value="${totalnucleos}" /></strong><img src="imagens/spacer_1x1px.png" width="5" border="0" /></div></td>                  
		               <td bordercolor="#ffffff"><div align="right" style="font-size: 12px; color: #000000;"><strong>Sócios: <f:formatNumber value="${totalsocios}" /></strong></div></td>
	               </tr>	       		   
	       	  </table>
