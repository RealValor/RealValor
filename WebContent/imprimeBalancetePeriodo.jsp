 		...
 		<!-- inicio -->
            ...
            <table width="660" border="1" align="center" bordercolor="#000000">
			   <tr bordercolor="#000000">
			      <td colspan="2"><div align="center" style="font-size: 16px; color: #333333;">BALANCETE DE VERIFICAÇÃO - PERIODO:<img src="imagens/spacer_1x1px.png" width="5" border="0" />${objMovIni.mesExtenso} A ${objMovFin.mesExtenso}/${objMovIni.ano}</div></td>
			   </tr>			   	  
		       <tr bordercolor="#000000">
		       ...
		       <tr bordercolor="#000000">     
		          <td width="510"><div align="left" style="font-size: 16px; color: #333333; font-weight: bold;"><img src="imagens/spacer_1x1px.png" width="5" border="0" />Saldo Total no Periodo:<img src="imagens/spacer_1x1px.png" width="5" border="0" />${objMovIni.mesExtenso} A ${objMovFin.mesExtenso}/${objMovIni.ano}</div></td> 
