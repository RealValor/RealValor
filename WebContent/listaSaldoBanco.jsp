...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	...
	<jsp:useBean id="objSal" class="beans.SaldoBanco" scope="session" />
	<div class="hero-unit" align="center">
		<div id="estrutura">
			<table width="764" frame="void">
			   <tr><td colspan="3"><div align="left" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #666666; font-weight: bold;">Listagem de Saldo em Bancos</div></td></tr>
	           <tr><td>&nbsp;</td></tr>
			</table>
			<form name="form" id="form" method="post">
			
			<table width="762" border="1">
			  	<tr><td colspan="5"><input type="button" onclick="enviar('IncluiSaldoBanco')" name="bt1" value="Voltar"></input></td></tr>
		          ...
		          <c:forEach var="saldo" items="${listSal}">
		               <c:if test="${saldo.banco.descricao!=''}"> 
					     	<tr bgcolor="#ffffff">
								...
								<td><div align="left" style="font-size: 12px; color: #000000;">${saldo.banco.descricao}</div></td>
								...
								<td><div align="center" style="font-size: 12px; color: #000000;"><f:formatNumber value="${saldo.valor}" type="currency"/></div></td>
				            </tr>
					   </c:if>
		          </c:forEach>
