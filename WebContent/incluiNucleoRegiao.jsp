			...
			<form name="form" id="form" method="post">
			  <table width="764" frame="void">            
	            ...
	            <tr>
	               ...
	               <input type="button" onclick="enviar('IncluiNucleoOperador')" id="bt1" name="bt1" value="Confirmar">
				  </div></td>
	            </tr>
	          </table>
	          <table width="760" border="1">
				   ...
				   <c:if test="${not empty listaNucleos}">
	             	<div align="center" style="font-size: 16px; color: #000000;"><strong>Núcleos Cadastrados</strong></div>
