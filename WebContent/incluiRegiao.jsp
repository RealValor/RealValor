	  ...
	  <div class="hero-unit" align="center">
		  <div id="estrutura">
	      	<table width="764" frame="void">
		       ...
		       <tr><td colspan="3"><div align="left" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #666666; font-weight: bold;">Cadastro de Região</div></td></tr>
		       <tr><td colspan="17">&nbsp;</td></tr>     
		    </table>
			...
			<form name="form" id="form" method="post">
			  <table width="764" frame="void">            
	            <tr>
	              ...
	              <input name="desc_banco" type="text" id="desc_banco" size="40" maxlength="100" style="font-size: 18px; color: #006633; font-weight: bold;" value="${objBan.descricao}"/><img src="imagens/spacer_1x1px.png" width="10" border="0" />Sigla:<img src="imagens/spacer_1x1px.png" width="5" border="0" />
