 ...
 <style type="text/css">
	 ...
	 .style14 {font-size: 10px}
	  ...
	  <div id="estrutura">
        ...
        <table width="764" frame="void">
		   ...
		   <tr><td colspan="3"><div align="left" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #666666; font-weight: bold;">Consulta Balancete Finalizado - Por Período</div></td></tr>     
		   <tr><td colspan="3">&nbsp;</td></tr>	  
	    </table>
        	...
        	<table width="763" frame="void">
	            <tr>
					<td><div align="left" class="style6">
	                   ...
	                   <select class="input-small" name="escolhemesIni" id="escolhemesIni" style="font-size: 16px; color: #006633; font-weight: bold;" onchange='document.getElementById("mesini").value=escolhemesIni.value;'>
	                   ...
	                   <input name="mesini" id="mesini" type="hidden" value="${objMovIni.mes}" title="Escolha o mes final na caixa de seleção" size="1" maxlength="1" readonly/>

	            	   <img src="imagens/spacer_1x1px.png" width="5" border="0" />a<img src="imagens/spacer_1x1px.png" width="5" border="0" />                
	                   ...
	                   <input type="button" onclick="enviar('ConsultaBalancete&tipo=periodo')" name="bt5" value="Confirma">
	            	</div></td>
	            </tr>
            </table>
            <table width="763" frame="void">
		...
		<form name="form" id="form" method="post">
	  	  <table width="763" frame="void">
                	...
                	<td>
                    	<div align="left">
				        	<input type="button" onclick="enviar('AtualizaDadosBalancete&tipo=periodo')" name="bt4" value="atualizar">
				        	<input type="button" onclick="enviar('AtualizaDadosBalancete&tipo=periodo&ano=0&mes=0')" name="bt6" value="limpar"> 
						</div>
                    </td>   
				</tr>
		  </table>
	...
	<script>
 	    window.onload = function(){
  	    	document.formNome.escolhemesIni.focus();
  	    	if(document.getElementById('mesini').value==0){document.getElementById('mesini').value=1;};
  	    	visualizar();
  	    };
		 ...
		 function visualizar(){
			...
			if(document.formNome.controle.value+1>1){
			   window.open(document.getElementById('urlSet').value+'imprimeBalancetePeriodo.jsp?cod='+seconds,'janela', 'width='+width+', height='+height+', top='+top+', left='+left+', scrollbars=yes, status=no, toolbar=no, location=no, directories=no, menubar=no, resizable=no, fullscreen=no');
		    }
