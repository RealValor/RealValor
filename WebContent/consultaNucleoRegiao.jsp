	  ...
	  <div class="hero-unit" align="center">
		  <div id="estrutura">
	      	<table width="764" frame="void">
		       ...
		       <tr><td colspan="3"><div align="left" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #666666; font-weight: bold;">Núcleos habilitados no sistema</div></td></tr>
		       <tr><td colspan="17">&nbsp;</td></tr>     
		    </table>
	          ...
	          <table width="760" border="1">
				   ...
				   <c:if test="${not empty listaNucleos}">
					<tr bordercolor="#cccccc" bgcolor="#cccccc">
			      	   ...
			      	   <td><div align="center" style="font-size: 12px; color: #000000;"><strong>Associados</strong></div></td>
			      	   <!-- <td><div align="center" style="font-size: 12px; color: #000000;"><strong>Comunicador</strong></div></td> -->
	                </tr>          
			       </c:if>
			       <c:forEach var="linhaslista" items="${listaNucleos}">
	                  <c:if test="${linhaslista.regiao.codigo != regiao && totalnucleos>0}">
                  	   ...
                  	   <c:set var="regiao" value="${linhaslista.regiao.codigo}"/> 
	           	       ...
	           	       <tr bgcolor="#ffffff">
	           	       	<td><div align="center"><a href='ConsultaNucleo' title="Edita Núcleo"><img src="imagens/edit.png" width="16" height="16" border="0" align="middle" /></a></div></td> 
	                	...
	                	<td>
	                    	<div align="left">
		                    	<c:if test="${objUsu.nivel > 3 }">
						        	<input type="button" onclick="enviar('IncluiNucleo')" id="bt1" name="bt1" value="Incluir Núcleo">
								</c:if>
							</div>   
	                    </td>   
	  				</tr>
     	  ...
     	  function enviar(pModu){
			 ...
			 if(pModu!='ListaNucleo'){
				 if(preencheCampo(document.form.desc_nucleo,'Descricao')){
					...
					//alert(document.getElementById("cpf_operador").value);
