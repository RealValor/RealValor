 		...
 		<!-- inicio -->
            ...
            <table width="660" border="1" align="center" bordercolor="#000000">
			   <tr bordercolor="#000000">
			      <td colspan="2"><div align="center" style="font-size: 16px; color: #333333;">BALANCETE (PRÉVIO) DE VERIFICAÇÃO - MÊS:<img src="imagens/spacer_1x1px.png" width="5" border="0" />${objMovIni.mesExtenso}/${objMovIni.ano}</div></td>
			   </tr>			   	  
		       <tr bordercolor="#000000">
