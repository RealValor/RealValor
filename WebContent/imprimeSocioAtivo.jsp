		...
		<div align="right"><a href="javascript:window.print()" ><img src="imagens/imprimir.PNG" alt="Imprimir" border="0"/></a></div>		   	  
 		...
 		<!-- inicio -->
            <table width="763" frame="void" >
               ...
               <div align="left" style="font-size: 16px; color: #333333;">Lista de Associados Ativos<img src="imagens/spacer_1x1px.png" width="5" border="0" />- <f:formatDate value="${data}" type="date" pattern="dd/MM/yyyy" /></div>
		       ...
		       <c:forEach var="linhaslistasocio" items="${listSocio}">
				  ...
				  <c:if test="${grau != linhaslistasocio.grau}">
		            <c:if test="${contgrau > 0}">
		            	<tr bordercolor="#ffffff"><td colspan="3"><div align="left" style="font-size: 16px; color: #333333;">Total: ${contgrau}</div></td></tr>
		            </c:if>               
				  	<tr bordercolor="#ffffff"><td colspan="3">&nbsp;</td></tr>					
                    <tr bordercolor="#ffffff"><td colspan="3"><div align="left" style="font-size: 16px; color: #333333;">${linhaslistasocio.grau=='M'?'QUADRO DE MESTRES':(linhaslistasocio.grau=='C'?'CORPO DO CONSELHO':(linhaslistasocio.grau=='I'?'CORPO INSTRUTIVO':'QUADRO DE SÓCIOS'))}</div></td></tr>
				  ...
				  <c:set var="conttotal" value="${conttotal + 1}"/>
           	      <tr bordercolor="#000000">
               		...
               		<td width="54"><div align="left" class="style5 style9"><img src="imagens/spacer_1x1px.png" width="1" border="0" /></div></td>
                 </tr>
       		   </c:forEach>
		       <tr bordercolor="#ffffff"><td colspan="3"><div align="left" style="font-size: 16px; color: #333333;">Total: ${contgrau}</div></td></tr>       		   
		       <tr bordercolor="#ffffff"><td colspan="3"><div align="left" style="font-size: 16px; color: #333333;">Total Geral: ${conttotal}</div></td></tr>       		   
            </table>
            </form>
