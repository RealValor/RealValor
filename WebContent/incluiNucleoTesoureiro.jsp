	  ...
	  <div class="hero-unit" align="center">
		  <div id="estrutura">
	      	<table width="764" frame="void">
		       ...
		       <tr><td colspan="3"><div align="left" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #666666; font-weight: bold;">Cadastro de Núcleo - ${objNucleo.regiao.descricao} (Operador Inicial)</div></td></tr>
		       <tr><td colspan="17">&nbsp;</td></tr>     
		    </table>
			  ...
			  <table width="764" frame="void">            
	            <tr>
	              <td colspan="3"><div align="left" class="style6">Núcleo:<img src="imagens/spacer_1x1px.png" width="24" border="0" />
				   <!--  
	               <input name="desc_nucleo" type="text" id="desc_nucleo" class="input-xlarge" size="40" maxlength="100" style="font-size: 18px; color: #006633; font-weight: bold;" value="${objNucleo.nome}"/><img src="imagens/spacer_1x1px.png" width="5" border="0" />CNPJ:<img src="imagens/spacer_1x1px.png" width="5" border="0" />
	                	...
	                	<td colspan="3">
	                    	<div align="left">
		                    	<c:if test="${objUsu.nivel > 2 }">
						        	<input type="button" onclick="enviar('IncluiNucleo')" id="bt1" name="bt1" value="Incluir">
						        	<!-- 
